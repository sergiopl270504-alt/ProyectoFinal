...
if (formularioPropiedad) {
     ...
     */
    /**
     * Gestiona el envío del formulario de nueva propiedad.
     * 
    ...
    formularioPropiedad.addEventListener('submit', async (e) => {
        ...
        const estacionamiento = document.getElementById('estacionamiento').value === 'true';
        const calle = document.getElementById('calle').value;

        // Imágenes de alta calidad para propiedades
        const imagenesCasas = [
